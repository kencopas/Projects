...
data (folder) - holds json files

utils (folder) - holds PySpark and MySQL connector utilities
...
config.json - holds configurations for pyspark, jdbc, and mysql (created because of overlapping and confusing configurations)

init.sql - holds sql queries for table initializations if they don't exist

main.py - application, integrates utilities, config.json, init.sql, data.